...
from tensorflow.keras.layers import GlobalMaxPooling1D, Input, Dense, Multiply, MaxPooling1D, LSTM, Conv1D, Bidirectional, concatenate, Dropout, GlobalMaxPooling1D
...
if __name__ == '__main__':
    ...
    qa = QA_selection(num_features = 400, question_length = 10, answer_length = 50, \
        question_encoder_shape = 64, answer_encoder_shape = 64, batch_size = 1, learning_rate = 0.001)
    #read data
